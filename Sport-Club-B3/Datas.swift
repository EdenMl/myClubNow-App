...
/*
    ...
    les données sont modifiables ci-dessous
 */
class GlobalData: ObservableObject {
    ...
    @Published var allTeam = [
        ...
        Team(id: 4, name: "Nantes", numDaysPlayed: 14, points: 0, placeTmp: 0, matchesWon: 0, matchesLost: 0, matchesDraw: 0, league: League(id: 1, name: "ProLigue 21/22", numDays: 30, dateStart: Date(), dateEnd: Date())),
    ]
    ...
    @Published var allMatch = [
        ...
        Match(id: 1, pointsHomeTeam: 31, pointsOutsideTeam: 26, dateStart: Date(), location: "Nantes", numDaysLeague: 13, highlighted: false, displayable: true, home: Team(id: 4, name: "Nantes", numDaysPlayed: 14, points: 0, placeTmp: 0, matchesWon: 0, matchesLost: 0, matchesDraw: 0, league: League(id: 1, name: "ProLigue 21/22", numDays: 30, dateStart: Date(), dateEnd: Date())), outside: Team(id: 1, name: "JS Cherbourg", numDaysPlayed: 0, points: 0, placeTmp: 0, matchesWon: 0, matchesLost: 0, matchesDraw: 0, league: League(id: 1, name: "ProLigue 21/22", numDays: 30, dateStart: Date(), dateEnd: Date()))),
    ]
